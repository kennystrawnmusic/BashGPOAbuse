...
# Stage 1: elevates the Stage 2 payload's token to TrustedInstaller privileges using service binary paths. This also has the desirable side-effect of making the actual reverse shell double-encoded, which is a good thing for evasion purposes.
